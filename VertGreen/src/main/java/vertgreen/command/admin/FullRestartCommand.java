...
public class FullRestartCommand extends Command implements ICommandOwnerRestricted {

    private static final org.slf4j.Logger log = LoggerFactory.getLogger(FullRestartCommand.class);
